    ...
    <div>
      ...
      <div className="bg-secondary">
        <ul  className="d-flex p-2 align-items-center gap-5">
          <li onClick={()=>navigate(ROUTER.colaInfo)} className="text-light fs-5 fw-medium about-li">Cola Info</li>
          <li onClick={()=>navigate(ROUTER.chipsInfo)} className="text-light fs-5 fw-medium about-li">Chips Info</li>
          <li onClick={()=>navigate(ROUTER.fastFoodInfo)} className="text-light fs-5 fw-medium about-li">Fast-Food Info</li>
        </ul>
      </div>
